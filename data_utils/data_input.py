...
from data_utils.transform import resize, random_flip, random_crop, center_crop
...
def test():
    ...
    dataset = ListDataset(root='E:\\st\\',
                          list_file='D:\\pycode\\retinanet\\data\\data2.txt',
                          train=True, transform=transform, input_size=300)
